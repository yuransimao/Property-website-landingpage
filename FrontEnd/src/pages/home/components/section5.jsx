...
function Section5() {
  ...
  return (
    <React.Fragment>
      <div className=' flex bg-gradient-to-t from-green-800/10 to-white flex-col items-center justify-center px-4 lg:px-24 md:px-12 sm:px-6  py-4 lg:py-16 md:py-8 gap-8'>
        <div>
